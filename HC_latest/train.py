...
if dataset == 'sysu':
    data_path = 'D:/reid/DataSet/SYSU-MM01/'
    log_path = args.log_path + 'sysu_log/'
    test_mode = [1, 2]  # thermal to visible
elif dataset == 'regdb':
    data_path = 'D:/reid/DataSet/RegDB/'
...
def train(epoch, loss_log):
    ...
    for batch_idx, (input1, input2, label1, label2) in enumerate(trainloader):
        ...
        if args.method == 'id':
            ...
            loss0 = loss0 + w_hc * loss_c0 + 0.5 * loss_tri0
            loss1 = loss1 + w_hc * loss_c1 + 0.5 * loss_tri1
            loss2 = loss2 + w_hc * loss_c2 + 0.5 * loss_tri2
            loss3 = loss3 + w_hc * loss_c3 + 0.5 * loss_tri3
            loss4 = loss4 + w_hc * loss_c4 + 0.5 * loss_tri4
